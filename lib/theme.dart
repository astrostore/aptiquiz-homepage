...
class LightModeColors {
  static const lightPrimary = Color(0xFF6366F1); // Modern indigo
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFEEF2FF);
  static const lightOnPrimaryContainer = Color(0xFF1E1B89);
  static const lightSecondary = Color(0xFF8B5CF6); // Purple accent
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFF06B6D4); // Cyan
  ...
  static const lightAppBarBackground = Color(0xFFEEF2FF);
}

class DarkModeColors {
  static const darkPrimary = Color(0xFFA5B4FC);
  static const darkOnPrimary = Color(0xFF1E1B89);
  static const darkPrimaryContainer = Color(0xFF3730A3);
  static const darkOnPrimaryContainer = Color(0xFFEEF2FF);
  static const darkSecondary = Color(0xFFC4B5FD);
  static const darkOnSecondary = Color(0xFF5B21B6);
  static const darkTertiary = Color(0xFF67E8F9);
